...
let INIT_CAM_LAT            = 37.6271170//37.6273511
let INIT_CAM_LON            = -122.4244671//-122.42468757
let INIT_CAM_ZOOM: Float   = 18.8

let BSB_LAT             = 37.6270650 //37.62711860656018 (increase to go up N)
let BSB_LON             = -122.4244872 //-122.42447912693024 (increase to go left down)
